...
const About = () => {
  return (
    <div
      name="About"
      className="w-full min-h-screen bg-gradient-to-b from-gray-800 to-black text-gray-400"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full min-h-screen">
        ...
        <p className="text-xl mt-5 sm:mt-8 md:mt-10 lg:mt-12">
        ...
        <p className="text-xl mt-5 sm:mt-8 md:mt-10 lg:mt-12">
          ...
          valuable asset in delivering high-impact solutions.
        </p>
      </div>
    </div>
  );
